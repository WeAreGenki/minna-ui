...
<!--
  FIXME: This component is no longer sourced by Navbar.html
    ↳ Figure out a way to optionally use this component to create dynamic menus
      ↳ This could also be the start of work on a mega menu concept
      ↳ Figure out how to do this without bundling the other components if just
        the simple Navbar is used without any submenus etc.
-->
